...
```json
{
  ...
  "uploadMessage": 1, // 1 to upload the message as a file (for very long message), 0 to only upload the message if the count of characters is greater than 60,000 (defalut behaviour).
